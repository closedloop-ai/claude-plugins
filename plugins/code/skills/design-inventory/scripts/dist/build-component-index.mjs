...
var EXCLUDED_DIRS = /* @__PURE__ */ new Set(["node_modules", "dist"]);
...
`);
  ...
  const outPath = typeof values.out === "string" && values.out.length > 0 ? values.out : join(repo, ".closedloop-ai", "design-inventory", "component-index.json");
