...
- **If all clear:** Write state.json with `"status": "COMPLETED"`, THEN output `<promise>IMPLEMENTATION_COMPLETE</promise>`. Never output the promise without writing state.json first. Tell the user implementation is complete.
