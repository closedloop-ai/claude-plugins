...
# ---------------------------------------------------------------------------
# Schema normalization: fill canonical fields on partially-shaped findings
# emitted by reviewer agents and other producers that don't emit the
# canonical schema natively.
# ---------------------------------------------------------------------------
