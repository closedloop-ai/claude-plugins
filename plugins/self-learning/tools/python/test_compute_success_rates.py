...
class TestMatching:
    ...
    def test_jaccard_match(self) -> None:
        ...
        assert match_outcome_to_pattern(
            "run all unit tests first before push", "run unit tests first before merge"
        )
...
class TestComputeRates:
    ...
    def test_single_applied_pattern(self) -> None:
        ...
        outcomes = [
            {
                "pattern_trigger": "test trigger summary",
                "status": "applied",
                "unverified": "",
                "iteration": "1",
            },
    ...
    def test_fuzzy_matching_across_patterns(self) -> None:
        ...
        outcomes = [
            {
                "pattern_trigger": "always check token expiry before API",
                "status": "applied",
                "unverified": "",
                "iteration": "1",
            },
...
class TestFlagAssignment:
    ...
    def test_prune_flag_high_count_low_rate(self) -> None:
        ...
        outcomes = [
            {
                "pattern_trigger": "prune me trigger",
                "status": "applied",
                "unverified": "1",
                "iteration": str(i),
            }
    ...
    def test_no_prune_below_threshold_count(self) -> None:
        ...
        patterns = [
            {
                "id": "P-001",
                "summary": "not enough applications trigger",
                "confidence": "high",
                "success_rate": "0.80",
                "flags": "",
                "category": "pattern",
        ...
        outcomes = [
            {
                "pattern_trigger": "not enough applications trigger",
                "status": "applied",
                "unverified": "1",
                "iteration": str(i),
            }
    ...
    def test_no_prune_above_success_threshold(self) -> None:
        ...
        patterns = [
            {
                "id": "P-001",
                "summary": "above success threshold trigger",
                "confidence": "medium",
                "success_rate": "0.50",
                "flags": "",
                "category": "pattern",
        ...
        outcomes = [
            {
                "pattern_trigger": "above success threshold trigger",
                "status": "applied",
                "unverified": "",
                "iteration": str(i),
            }
