...
description: >
  Upload a file as a ClosedLoop document (PRD, implementation plan, feature, or
  template).
...
allowed-tools: >-
  Bash, Read, AskUserQuestion, mcp__closedloop__create-document,
  mcp__closedloop__create-document-version, mcp__closedloop__list-projects
---
