---
description: 'Command: cancel-code (imported from Claude Code)'
allowed-tools:
  - 'Bash(test -f .closedloop-ai/closedloop-loop.local.md:*)'
  - Bash(rm .closedloop-ai/closedloop-loop.local.md)
  - Read(.closedloop-ai/closedloop-loop.local.md)
hide-from-slash-command-tool: 'true'
name: cmd-cancel-code
---
