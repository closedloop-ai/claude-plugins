...
name: closedloop-env
description: >-
  Provides ClosedLoop environment paths (CLOSEDLOOP_WORKDIR, CLAUDE_PLUGIN_ROOT)
  to agents. This skill should be used by any agent that needs to access
  ClosedLoop run directories, plugin schemas, or other path-dependent resources.
---
